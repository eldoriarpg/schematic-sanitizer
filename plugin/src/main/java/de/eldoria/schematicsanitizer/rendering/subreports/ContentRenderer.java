...
public record ContentRenderer(ContentReport report) {
    public static ContentRenderer create(ContentReport content) {
        return new ContentRenderer(content);
    }
    ...
    public int nonAirBlocks() {
        return report.nonAirBlocks();
    }

    public int totalCreatures() {
        return report.totalCreatures();
    }

    public int totalNonCreatures() {
        return report.totalNonCreatures();
    }

    public int creatures() {
        return report.creatures();
    }

    public int nonCreatures() {
        return report.nonCreatures();
    }
}
